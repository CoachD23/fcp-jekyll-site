...
<div class="staff-section staff-section-dark fade-in" style="margin-top: 3rem;">
  ...
  <div class="feature-grid" style="margin-top: 2rem;">
    ...
    <div class="feature-card fade-in">
      ...
      <h3>Recruiting</h3>
      <p>Individual recruiting plans, Hudl film, exposure events, and direct relationships with college coaches nationwide.</p>
    </div>
    <div class="feature-card fade-in">
  ...
  <div class="process-steps" style="margin-top: 2rem;">
    <div class="process-step fade-in">
      ...
      <div class="process-content">
        <h3>Apply Online</h3>
        <p>Complete our online application to begin the evaluation process. Our admissions team reviews every application personally.</p>
        <a href="/apply/" class="btn btn-primary" style="margin-top: 1rem; display: inline-block;">Start Your Application</a>
      </div>
    </div>
    <div class="process-step fade-in">
      <div class="process-number">2</div>
      <div class="process-content">
        <h3>Receive Your Admissions Packet</h3>
        <p>Within 2–3 business days, you'll receive a personalized packet including:</p>
        <ul class="process-list">
          <li>Cost of Attendance breakdown</li>
          <li>Health Insurance Forms</li>
          <li>Medical Waivers & Physical Form</li>
          <li>Program Packet & FAQ</li>
          <li>Media Release</li>
        </ul>
      </div>
    </div>
    <div class="process-step fade-in">
      ...
      <div class="process-content">
        ...
        <p>After accepting your packet, you are conditionally accepted into the program. A financial deposit secures your housing assignment and roster spot.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="program-offers fade-in" style="margin-top: 3rem;">
  ...
  <div class="faq-grid">
    <div class="faq-card fade-in">
      <h3>Do you provide I-20s?</h3>
      <p>Yes. I-20s are provided by our accredited educational partner, allowing international student-athletes to obtain F-1 student visas.</p>
    </div>
    <div class="faq-card fade-in">
      <h3>What is a Post-Grad Program?</h3>
      <p>A post-graduate program prepares athletes academically and athletically for college. Unlike traditional schooling, post-grad programs focus heavily on sports development while continuing academic progress — bridging the gap between high school and college.</p>
    </div>
    <div class="faq-card fade-in">
    ...
    <div class="faq-card fade-in">
      ...
      <p>The NCAA allows a one-year grace period after high school graduation (except tennis and hockey). During this time, a post-grad year will not affect your eligibility. You can compete at a high level while taking classes and building your academic profile — buying valuable time for the recruiting process.</p>
    </div>
    <div class="faq-card fade-in">
