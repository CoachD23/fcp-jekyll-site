---
layout: page
title: "Coaching Staff & Management | Florida Coastal Prep"
subtitle: The Team Behind the Team
description: "Meet FCP's coaching staff — NBA All-Star Kenny Anderson, Director Lee DeForest (25+ years experience), and elite trainers behind 500+ college commits."
  ...
  <div class="executive-grid">
    <div class="executive-card fade-in" id="lee">
      ...
      <div class="executive-info">
        <h3>Lee DeForest</h3>
        <p class="exec-role">Athletic Director / Director of Operations</p>
        <p class="exec-bio">Seventh-year HS Director and Director of Operations with 25 years of basketball coaching across DI, DII, NAIA, and JUCO levels. Notable achievements include coaching Sean East (now in NBA G-League), Brandon Maclin (DePaul), Kylin Green (Houston Baptist), and Ring Malith (SIU Edwardsville).</p>
        <div class="exec-stats">
          <div class="exec-stat"><strong>25</strong><span>Years Coaching</span></div>
          <div class="exec-stat"><strong>4</strong><span>NCAA Divisions</span></div>
          <div class="exec-stat"><strong>7</strong><span>Years at FCP</span></div>
        </div>
      </div>
    </div>
