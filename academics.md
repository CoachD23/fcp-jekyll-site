...
<div class="fade-in" style="max-width: 900px; margin: 2rem auto;">
  <img src="/assets/images/academics/academic-studying.jpg" alt="Florida Coastal Prep student-athletes studying together at the Fort Walton Beach campus" width="800" height="600" loading="lazy" style="width: 100%; border-radius: 10px; aspect-ratio: 4/3; object-fit: cover;">
</div>
...
<section class="program-offers fade-in" style="margin-top: 2rem;">
  ...
  <details class="mobile-disclosure">
    <summary>High School & Post-Graduate Academics</summary>
...
<section class="program-offers fade-in" style="margin-top: 3rem;">
  ...
  <div class="feature-grid" style="margin-top: 2rem; max-width: 700px;">
    ...
    <div class="feature-card fade-in">
      ...
      <h3>AI & Technology of the Future</h3>
...
<div class="staff-section staff-section-dark" style="margin-top: 3rem;">
  ...
  <div class="feature-grid ncaa-grid" style="margin: 1.5rem auto 0;">
    ...
    <div class="feature-card fade-in">
      ...
      <h3>Test Scores</h3>
      <p>SAT or ACT scores are required to verify NCAA academic eligibility. Our staff helps guide you through the testing process.</p>
    </div>
    <div class="feature-card fade-in">
...
<script type="application/ld+json">
{
  ...
  "description": "Accredited academic program for student-athletes featuring dual enrollment with Colorado Christian University, NCAA-approved coursework, leadership electives, and flexible scheduling.",
