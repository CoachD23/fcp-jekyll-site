...
<div class="housing-section fade-in">
  ...
  <div class="housing-layout">
    ...
    <div class="housing-info">
      <p>Our most popular housing option — and the closest to the gym. Team houses are fully furnished with cable, Wi-Fi, and full kitchens. Athletes live together in a team environment that builds chemistry on and off the court.</p>
      <p>Located just minutes from the <a href="/training/" style="color: #0a1628; font-weight: 600; text-decoration: underline;">Spartan Training Center</a> and close to the beach, team houses offer the perfect balance of convenience and comfort. Shared living spaces encourage team bonding, study sessions, and the daily structure that prepares athletes for college life.</p>
...
<div class="housing-section housing-section-alt fade-in">
  ...
  <div class="housing-layout housing-layout-reverse">
    ...
    <div class="housing-info">
      <p>Fully furnished 2-bed/1-bath condos just minutes from the white sand beaches of the Gulf of Mexico. Five units split across two duplex buildings, a flat studio, and a standalone house — all in a quiet neighborhood close to the water.</p>
      <p>Beach condos offer a relaxed coastal setting while keeping athletes within easy reach of the gym and campus. The Emerald Coast lifestyle — sunshine, salt air, and recovery walks on the beach — is part of what makes training at FCP unlike anywhere else.</p>
      <div class="housing-highlights">
        ...
        <div class="highlight-item"><strong>Gulf</strong><span>Coast Living</span></div>
      </div>
    </div>
  </div>
</div>
...
<div class="trust-bar fade-in" style="margin: 2rem auto; max-width: 900px;">
  ...
  <div class="trust-bar-content">
    ...
    <p>A dedicated house coach lives on-site and is present at all times. Curfew enforcement, room checks, and structured daily schedules ensure a safe, focused environment for every athlete. All housing assignments are based on availability and program enrollment.</p>
  </div>
</div>
...
<script type="application/ld+json">
{
  ...
  "name": "Florida Coastal Prep — Student-Athlete Housing",
  "description": "Supervised, fully furnished housing for student-athletes including team houses and beach condos in Fort Walton Beach, FL.",
  "url": "https://floridacoastalprep.com/housing/",
  "address": {
    "@type": "PostalAddress",
  ...
  "amenityFeature": [
    {"@type": "LocationFeatureSpecification", "name": "24/7 Staff Supervision"},
    {"@type": "LocationFeatureSpecification", "name": "Fully Furnished"},
    {"@type": "LocationFeatureSpecification", "name": "Wi-Fi & Cable"},
